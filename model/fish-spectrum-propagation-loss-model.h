 ...
 */
#ifndef FISH_SPECTRUM_PROPAGATION_LOSS_MODEL_H
#define FISH_SPECTRUM_PROPAGATION_LOSS_MODEL_H
 ...
 */
class FishSpectrumPropagationLossModel : public SpectrumPropagationLossModel
{

public:
  FishSpectrumPropagationLossModel ();
  ~FishSpectrumPropagationLossModel ();
