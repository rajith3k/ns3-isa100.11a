 ...
 */
#ifndef FISH_WPAN_SPECTRUM_VALUE_HELPER_H
#define FISH_WPAN_SPECTRUM_VALUE_HELPER_H
 ...
 * \ingroup lr-wpan
 *
 * \brief This class defines all functions to create spectrum model for FishWpan
 */
class FishWpanSpectrumValueHelper
{
public:
  FishWpanSpectrumValueHelper ();
  virtual ~FishWpanSpectrumValueHelper ();
